...
const ProductCard = ({ dt }) => {
    ...
    return (
        <div className="w-[400px] h-[400px] relative m-2 rounded-md border border-slate-800">
            <img src={dt?.url} className="w-full h-full rounded-md" alt="" />
            <div className="absolute left-0 bottom-0 bg-slate-800 text-white w-full px-2">
            ...
            {openEdit && (
                <div className="bg-slate-800 border border-white text-white absolute top-5 right-2 p-2 text-sm">
                    <div
